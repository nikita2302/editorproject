...
public class NoteEditor extends Activity {
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
          ...
          //  System.out.println(note);
            //Toast.makeText(NoteEditor.this, note, Toast.LENGTH_LONG).show();
    ...
    private final void texttospeech() {
            ...
            ContentValues values = new ContentValues();
             ...
             Toast.makeText(NoteEditor.this, text, Toast.LENGTH_LONG).show();
           Intent it= new Intent(NoteEditor.this, SpeakingAndroid.class);
            it.putExtra("text1",text);
            System.out.println(text);
            startActivity(it);
          }
